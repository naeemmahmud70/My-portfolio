            ...
            <div className="row height">
                <div className="col-md-7 text-white d-flex align-items-center">
                    <div className="p-5">
                        ...
                        />
                        <div>
                            <a href="https://drive.google.com/file/d/13Ky3nsUPtlDc6naSlSldO9_7RiVNEvTp/view?usp=drivesdk" target="_blank"><button className="btn-style m-3">Download Resume <FontAwesomeIcon icon={faFileDownload} /></button></a>
                        </div>
                    </div>
                </div>
