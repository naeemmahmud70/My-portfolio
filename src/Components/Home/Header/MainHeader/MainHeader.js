        ...
        <div className="row height">
            <div className="col-md-7 text-white d-flex align-items-center">
                <div className="p-5">
                    ...
                    <a href="https://drive.google.com/file/d/1xJ9zDhgtQ43JrV4c2c2a87wfy97k-r48/view?usp=drivesdk"><button className="btn-style m-3">Download Resume <FontAwesomeIcon icon={faFileDownload} /></button></a>
                </div>
            </div>
